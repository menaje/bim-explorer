...
const REQUIRED_PATHS = [
  ...
  ".github/workflows/bim-surface-release.yml",
  ...
  "apps/federated-bim-surface-browser-probe/README.md",
  "apps/federated-bim-surface-browser-probe/app.mjs",
  "apps/federated-bim-surface-browser-probe/index.html",
  "apps/federated-bim-surface-browser-probe/styles.css",
  ...
  "apps/retained-overlay-browser-probe/README.md",
  "apps/retained-overlay-browser-probe/app.mjs",
  ...
  "compatibility/bim-surface.json",
  "compatibility/bim-retained-overlay.json",
  ...
  "compatibility/evidence/bim-retained-overlay-browser-2026-08-15.json",
  "compatibility/evidence/bim-retained-overlay-vscode-2026-08-15.json",
  "compatibility/evidence/bim-retained-overlay-viewer-core-2026-08-15.json",
  "compatibility/evidence/bim-retained-overlay-package-release-ready-2026-08-15.json",
  "compatibility/evidence/federated-bim-surface-headless-2026-08-09.json",
  "compatibility/evidence/federated-bim-surface-browser-2026-08-09.json",
  "compatibility/evidence/federated-bim-surface-package-2026-08-09.json",
  "compatibility/evidence/federated-bim-surface-package-2026-08-11.json",
  "compatibility/evidence/federated-bim-surface-package-release-ready-2026-08-11.json",
  "compatibility/evidence/federated-bim-surface-physical-gpu-darwin-arm64-2026-08-11.json",
  ...
  "compatibility/evidence/e57-multiple-scan-profile-2026-08-08.json",
  ...
  "compatibility/evidence/gltf-reference-source-external-resource-products-darwin-arm64-2026-08-11.json",
  "compatibility/evidence/gltf-reference-source-khr-mesh-quantization-products-darwin-arm64-2026-08-11.json",
  "compatibility/evidence/gltf-reference-source-ext-meshopt-products-darwin-arm64-2026-08-11.json",
  "compatibility/evidence/gltf-reference-source-base-color-texture-products-darwin-arm64-2026-08-11.json",
  "compatibility/evidence/gltf-reference-source-jpeg-base-color-texture-products-darwin-arm64-2026-08-11.json",
  "compatibility/evidence/gltf-reference-source-external-buffer-view-texture-products-darwin-arm64-2026-08-11.json",
  ...
  "compatibility/evidence/bim-product-shell-representative-physical-gpu-darwin-arm64-2026-08-11.json",
  "compatibility/evidence/bim-product-shell-viewer-core-product-entrypoints-2026-08-11.json",
  ...
  "docs/adr/ADR-0003-host-neutral-bim-surface.md",
  "docs/branch-release-workflow.md",
  "docs/bim-surface-release.md",
  ...
  "fixtures/gltf/public-khronos-box-textured-buffer-view/manifest.json",
  "fixtures/gltf/derived-khronos-box-mesh-quantization/manifest.json",
  "fixtures/gltf/derived-khronos-box-meshopt/manifest.json",
  "fixtures/e57/public-libe57-coloured-cube/manifest.json",
  "fixtures/e57/public-libe57-bunny-profiles/manifest.json",
  "fixtures/e57/public-e57-example-multiple-scan/manifest.json",
  ...
  "packages/bim-reference-anchor/README.md",
  "packages/bim-reference-anchor/package.json",
  "packages/bim-reference-anchor/src/index.mjs",
  "packages/federated-bim-surface/README.md",
  ...
  "packages/federated-bim-surface/src/package-entry.mjs",
  "packages/bim-surface-hit/README.md",
  "packages/bim-surface-hit/package.json",
  ...
  "packages/bim-surface/README.md",
  "packages/bim-surface/SOURCE_OFFER.md",
  "packages/bim-surface/package.json",
  ...
  "scripts/check-bim-surface-compatibility.mjs",
  "scripts/check-federated-bim-surface-compatibility.mjs",
  ...
  "scripts/check-bim-retained-overlay-compatibility.mjs",
  ...
  "scripts/build-bim-surface-release.mjs",
  "scripts/build-federated-bim-surface.mjs",
  "scripts/build-federated-bim-surface-v0.3.mjs",
  "scripts/build-federated-bim-surface-release.mjs",
  "scripts/build-bim-surface.mjs",
  ...
  "scripts/compare-bim-surface-release.mjs",
  ...
  "scripts/fetch-public-e57-profile-fixtures.mjs",
  "scripts/fetch-public-e57-multiple-scan-fixture.mjs",
  ...
  "scripts/gpu-qualification-profile.mjs",
  ...
  "scripts/public-gltf-resource-bundle-fixture.mjs",
  "scripts/public-gltf-quantized-fixture.mjs",
  "scripts/public-e57-fixture.mjs",
  "scripts/public-e57-profile-fixtures.mjs",
  "scripts/public-e57-multiple-scan-fixture.mjs",
  ...
  "scripts/qualify-representative-models-physical-gpu.mjs",
  "scripts/qualify-bim-federation.mjs",
  "scripts/qualify-bim-federation-product-scale.mjs",
  "scripts/qualify-e57-public-sample.mjs",
  "scripts/qualify-e57-profile-matrix.mjs",
  "scripts/qualify-e57-multiple-scan-profile.mjs",
  ...
  "scripts/qualify-gltf-resource-bundle-products.mjs",
  "scripts/qualify-gltf-mesh-quantization-products.mjs",
  "scripts/public-gltf-meshopt-fixture.mjs",
  "scripts/qualify-gltf-meshopt-products.mjs",
  "scripts/qualify-gltf-jpeg-texture-products.mjs",
  "scripts/qualify-gltf-buffer-view-texture-products.mjs",
  "scripts/qualify-gltf-texture-products.mjs",
  "scripts/qualify-community-release.mjs",
  "scripts/qualify-bim-model-source.mjs",
  "scripts/qualify-bim-surface-package.mjs",
  "scripts/qualify-federated-bim-surface.mjs",
  "scripts/qualify-federated-bim-surface-browser.mjs",
  "scripts/qualify-federated-bim-surface-package.mjs",
  "scripts/qualify-federated-bim-surface-v0.3-package.mjs",
  "scripts/qualify-federated-bim-surface-physical-gpu.mjs",
  "scripts/federated-bim-surface-spatial-consumer-evidence.mjs",
  "scripts/federated-bim-surface-release-evidence.mjs",
  "scripts/qualify-federated-bim-surface-vscode.mjs",
  "scripts/qualify-retained-overlay-browser.mjs",
  "scripts/qualify-retained-overlay-viewer-core.mjs",
  "scripts/qualify-retained-overlay-vscode.mjs",
  ...
  "scripts/build-viewer-core-product.mjs",
  "scripts/qualify-viewer-core-product-entrypoints.mjs",
  ...
  "scripts/serve-federated-bim-surface-browser-probe.mjs",
  "scripts/serve-retained-overlay-browser-probe.mjs",
  ...
  "specs/bim-surface-v0.1.md",
  "specs/bim-surface-v0.2.md",
  ...
  "specs/bim-retained-overlay-v0.1.md",
  ...
  "tests/compatibility/bim-retained-overlay.test.mjs",
  ...
  "tests/compatibility/bim-surface.test.mjs",
  "tests/compatibility/federated-bim-surface.test.mjs",
  ...
  "tests/federation/bim-reference-anchor.test.mjs",
  ...
  "tests/gltf/public-gltf-resource-bundle-fixture.test.mjs",
  "tests/gltf/public-gltf-texture-bundle-fixture.test.mjs",
  "tests/gltf/public-gltf-quantized-fixture.test.mjs",
  ...
  "tests/renderer/retained-overlay-packet.test.mjs",
  "tests/renderer/retained-overlay-renderer.test.mjs",
  ...
  "tests/point-source/e57-profile-matrix.test.mjs",
  "tests/point-source/e57-multiple-scan-profile.test.mjs",
  ...
  "tests/gltf/public-gltf-meshopt-fixture.test.mjs",
  "tests/release/community-release.test.mjs",
  "tests/release/bim-surface-release.test.mjs",
  "tests/release/branch-promotion.test.mjs",
  "tests/release/federated-bim-surface-release.test.mjs",
  "tests/semantic/semantic-explorer-probe.test.mjs",
  "tests/semantic/semantic-explorer.test.mjs",
  "tests/surface/bim-surface-package.test.mjs",
  "tests/surface/bim-surface.test.mjs",
  "tests/surface/bim-surface-hit.test.mjs",
  "tests/surface/federated-bim-surface-browser-probe.test.mjs",
  "tests/surface/federated-bim-surface-package.test.mjs",
  "tests/surface/federated-bim-surface.test.mjs",
  "tests/surface/federated-bim-surface-qualification.test.mjs",
  "tests/surface/gpu-qualification-profile.test.mjs",
