...
const REQUIRED_PATHS = [
  ...
  "compatibility/evidence/e57-browser-product-2026-08-08.json",
  "compatibility/evidence/e57-vscode-product-2026-08-08.json",
  ...
  "packages/e57-point-source/README.md",
  "packages/e57-point-source/package.json",
  ...
  "scripts/qualify-e57-browser-product.mjs",
  "scripts/qualify-e57-vscode-product.mjs",
  ...
  "tests/product/e57-browser-product.test.mjs",
  "tests/product/e57-vscode-product.test.mjs",
  "tests/point-source/e57-point-source.test.mjs",
