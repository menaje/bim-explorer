...
| BE-Q-002 | held | 첫 IFC engine과 implementation profile은 무엇인가 | 두 후보의 base/mapped fixture와 web-ifc Browser lifecycle·checkpoint cancellation·공개 대표 모델 Node/Browser parse·WebGL2 first-frame prototype은 통과했지만 선정은 보류 | #4 negative corpus, in-call cancellation, Browser package와 license qualification |
...
| BE-Q-004 | held | Browser와 Desktop의 첫 3D GPU backend는 무엇인가 | Browser WebGL2 first-frame·camera/view·pick·context/source-switch lifecycle 통과, Desktop과 physical GPU는 미확정 | #6 section/measurement, memory와 cross-Host benchmark |
