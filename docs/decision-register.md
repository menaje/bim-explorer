...
| BE-Q-002 | held | 첫 IFC engine과 implementation profile은 무엇인가 | 두 후보의 base/mapped fixture와 web-ifc Browser Worker·local-file·checkpoint cancellation prototype은 통과했지만 선정은 보류 | #4 large/negative corpus, in-call engine cancellation, Browser package와 license qualification |
