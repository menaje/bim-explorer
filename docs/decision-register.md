...
| BE-Q-004 | held | Browser와 Desktop의 첫 3D GPU backend는 무엇인가 | Browser WebGL2 first-frame·camera/view-state·dispose prototype 통과, Desktop과 physical GPU는 미확정 | #6 pointer/picking, context loss, memory와 cross-Host benchmark |
