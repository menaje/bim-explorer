...
product-scale 제품 file-open은 별도 Gate입니다. bounded local Browser/VS
...
16.9MB allocation cleanup을 통과했지만 product shell과 physical GPU를
승인하지 않습니다.
...
재현했습니다. 별도 product-scale source/renderer probe도 통과했지만
multi-source composite first-frame과 Browser/VS Code product file-open은
