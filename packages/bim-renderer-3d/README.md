...
input, visibility-driven range loading 또는 Viewer Core conformance를
주장하지 않습니다. measurement 단위는 source-coordinate-unit이며 IFC
unit 해석을 renderer authority로 만들지 않습니다.
